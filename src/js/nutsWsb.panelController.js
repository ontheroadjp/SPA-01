...
nutsWsb.panelController =  (function($) {
	 ...
	 */
	var btnenable = function(val,options) {
	 ...
	 * @return none
	 */
	var action = function(base, panelIndex, type, options) {
	 ...
	 * @return {[type]}         [description]
	 */
	var panelSwap = function(base, first, second, options) {
	...
	var panelAddToServer = function(base,panel,panelIndex,options) {
	 ...
	 * @return {[type]}       [description]
	 */
	var panelDeleteFromDOM = function(base,panel,panelIndex,options) {
		$('div#graylayer').remove();
	...
	var panelDeleteFromServer = function(base,panel,panelIndex,options) {
		// $('div#graylayer').remove();
		// panel.hide("slow", function(){
		// 	panel.remove();
		// 	init(base,options);
...
// 			panelController.init(base, options);
