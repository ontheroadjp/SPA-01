...
class Services extends Module {
	function __construct( $path ) {
		...
		$this->doc .= '<div class="row text-center">';
			...
			$this->doc .= '<p data-type="textarea" data-rows="5" data-textAlign="center">'.$this->content['text04'].'</p>';
			$this->doc .= '</div>';
			
			$this->doc .= '<div class="col-md-4 col-sm-4 col-xs-12">';
			$this->doc .= '<i class="fa fa-desktop  fa-5x"></i>';
			$this->doc .= '<h4 class="head-set" data-type="text">'.$this->content['text05'].'</h4>';
			$this->doc .= '<p data-type="textarea" data-rows="5" data-textAlign="center">'.$this->content['text06'].'</p>';
			$this->doc .= '</div>';
